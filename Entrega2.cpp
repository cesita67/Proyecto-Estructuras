...
//*requerimiento extra defensa de proyecto: 
...
void cargar_desde_archivo_txt(Dron *&principal) {
    ...
    while (getline(archivo_entrada, linea)) {
        ...
        if (leyendo_bitacoras && dron_actual != NULL) {
            // Si encontramos "No hay vuelos registrados", terminamos con este dron
            ...
            // Si encontramos una línea vacía después de bitácoras, podría ser el fin de este dron
            ...
            // Leer datos de la bitácora actual
                ...
                if (linea.find("  ID: ") != string::npos) {
                    ...
                    // Extraer solo el número (eliminar " minutos")
                    ...
                    // Extraer solo el número (eliminar " km")
